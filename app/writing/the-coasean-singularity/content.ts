// Generated from the standalone Coasean Singularity HTML launch artifact.
...
export const coaseanEssayHtml = String.raw`<header class="masthead">
  ...
  <h1>The Coasean<br>Singularity</h1>
  ...
  <p class="byline">Grant Stenger <span>&nbsp;·&nbsp; June 2026</span></p>
</header>
...
<section>
  ...
  <p>Start with the inequality. <strong>A market appears wherever the surplus a creator can capture from intermediating an exposure exceeds the cost of defining, verifying, pricing, and settling the claim that carries it.</strong> Hedging, financing, speculation, price discovery, allocation — these are the sources of surplus. Specification, data, legal form, collateral, market-making, settlement, fraud, disputes — these are the cost. For almost all of history the cost side won, so only the largest, most standardized risks ever cleared the bar: staple commodities, sovereign debt, the equity of great corporations. Everything else stayed trapped inside private ownership, opaque underwriting, or no transaction at all. The exposure was real. The market for it was priced out of existence by its own overhead.</p>
  ...
  <p>This is an old idea running in fast-forward. Ronald Coase taught that the line between what happens inside a firm and what happens out in a market is set by a single quantity — the cost of using the price mechanism. Where transacting is expensive, activity huddles inside firms, long-term contracts, and unpriced relationships; where it is cheap, the boundary moves outward and the price system takes over more of economic life. For most of a century that boundary crept. The wager of this essay is that the cost of using the price mechanism is now falling so far, and on so many margins at once, that the boundary no longer creeps — it runs away. Call it a <em>Coasean singularity</em>: the point at which making a market becomes so cheap that the share of the world mediated by explicit prices lurches outward faster than any settled intuition allows.</p>
...
<section>
  ...
  <p>The obvious objection deserves an answer before anything else, because it is the strongest one. You have described, the skeptic says, a forty-year decline in transaction costs — electronic trading, decimalization, the internet, the ETF — and you have dressed an extrapolation up as a revolution. This is a trend, not a phase change.</p>
  <p>It is a phase change, and the reason is that three different fixed costs are crossing their thresholds in the same handful of years. <strong>First, specification.</strong> Drafting and interpreting the contract that defines a claim used to require a securities lawyer per deal; language models make it nearly free, which collapses the legal and specification line items that gated the long tail. <strong>Second, settlement.</strong> Programmable money turns the movement of value from a multi-day interbank choreography into a state transition, and pushes compliance — identity, eligibility, reporting — <em>inside</em> the transaction rather than alongside it. Sub-cent payments that were absurd to process are now ordinary. <strong>Third, and most important, market-making.</strong> A claim with no natural crowd used to be unquotable; a software agent that can research, price, and stand as counterparty to a niche exposure at a fraction of a human's cost makes the long tail economic for the first time.</p>
  <p>Any one of these alone moves the boundary a little — the bottleneck simply shifts to whichever cost you didn't fix. It is the simultaneity that matters. When several necessary costs fall together, claims that were each blocked by a <em>different</em> binding constraint cross the line at the same time, and the count of viable markets does not drift upward. It jumps. We are early in that jump, which is exactly why the conclusion sounds implausible: we are reasoning about the far side of a discontinuity from the near side of it.</p>
  <blockquote class="pull">When fixed costs cross thresholds together, the curve does not slope upward. It jumps.</blockquote>
</section>

<section>
  <span class="num">IV · The Demand Was Always There</span>
  <h2>The mystery is the under-hedging</h2>
  <p>It is tempting to frame all this as a story about future demand — about exotic new markets people will someday want. That gets it backward. The mystery is not why there will be more hedging tomorrow. The mystery is why there is so little of it today.</p>
...
<section>
  <span class="num">V · The Arithmetic</span>
  <h2>The future holds trillions of markets</h2>
  <p>“Trillions” sounds like rhetoric. It is an order-of-magnitude estimate, and the exact exponent is not the point. Reckon the dimensions along which a claim can be defined. The economically relevant entities in one large economy — firms, households, creators, vehicles, buildings, municipalities, machines — already run to the hundreds of millions. Each carries dozens of measurable exposures. Add horizons from minutes to years, locations or contexts, and contract wrappers — equity, debt, revenue share, option, future, swap, insurance, event contract, access right, basket. Even with conservative counts, the product lands between tens and hundreds of trillions of candidate claims before a single basket, spread, or index multiplies the space again.</p>
  <p>The right objection is that almost all of those are redundant, uneconomic, or never able to clear the viability bar. Correct — and that is why the conclusion is hard to escape. Discard ninety-nine percent and you are still in the trillions. Discard 99.99 percent and you still clear ten billion: not a precise forecast, but a count unrecognizably larger than today's liquid market surface. The conclusion never rested on optimism about which claims trade. It rests on the dimensionality of measurable economic exposure, and that dimensionality is very high.</p>
  ...
  <blockquote class="pull">The number of markets is the pixel count of the economy — and the pixel count is about to explode.</blockquote>
</section>

<section>
  <span class="num">VI · Why Fragmentation Is Not Fatal</span>
...
<section>
  <span class="num">VIII · The Limits</span>
...
<section>
  <span class="num">X · The Dark Forest</span>
  <h2>The same wiring carries the cascade</h2>
  <p>A thesis that narrated only the upside would not deserve to be believed. The mechanism is neutral; its consequences are not, and three of them are worth dreading in proportion to how much one believes the rest of this essay.</p>
  <p>The resolution metaphor is a useful lie until it breaks. It makes the dimensionality legible, but prices are not passive pixels on a photograph of the economy. At high enough density, the camera becomes an engine: measuring, ranking, collateralizing, and trading a thing changes the thing being measured. The first harm is predation. Where humans negotiated too slowly to prey on each other at scale, agents do not. In decentralized markets, automated strategies already detect a pending transaction and reorder the queue to skim the value out of it — a class of extraction crypto people aptly call the dark forest — running into the billions a year. In a world where agents negotiate lane changes and crop futures alike, that predation generalizes, and it lands back on the core inequality: a tiny trade with real surplus is destroyed if the expected skim exceeds it. The defense is design — clear orders in discrete batches at a uniform price and the value of being microseconds faster evaporates — but the arms race between extraction and defense is a permanent feature, not a transient bug.</p>
  <p>The second is contagion. A world of trillions of cross-collateralized claims is densely wired, and dense wiring transmits shocks. The very architecture that makes the system possible — hedging idiosyncratic claims onto common factors — means a blow to one factor hits everything that loads on it at once, and cross-collateralized players forced to liquidate carry a local failure across nominally unrelated markets. There is a darker version still: if all the idiosyncratic residue gets warehoused by a handful of factor-liquidity engines, the system has dispersed everyday risk while quietly concentrating tail risk onto a few balance sheets. That is the structure of 2008, rebuilt at the scale of everything.</p>
  <p>The third harm is human rather than systemic. An economy in which every action carries a price demands relentless calculation, and there is real value in the things that are <em>not</em> for sale — in courtesies with no meter running, in relationships not continuously marked to market. The cautionary artifact here is not a model but a man: years before any of this infrastructure existed, an individual issued a hundred thousand shares in himself and sold his shareholders votes over his own life — what to wear, which party to register with, whom to date. The lesson was not that the market failed but that it worked. His investors approved some life choices, constrained others, and eventually a relationship itself had to be unwound through the shareholder apparatus, with the partner's stake bought out like a position. That a thing <em>can</em> be priced is not an argument that it should be. As markets become ambient, the locus of oversight has to move with them — from the regulation of <em>venues</em>, which assumes markets live in identifiable rooms, to the regulation of <em>claims</em>, which asks of any state-contingent transfer whether it is consensual, capped, disclosed, manipulation-resistant, and free of systemic externality. The room is gone. The questions remain.</p>
</section>

<section>
  <span class="num">XI · What This Predicts</span>
  <h2>Flags planted in the ground</h2>
  <p>A vision is cheap unless it is falsifiable, so here are the specific, dated calls the argument commits me to. The dates are deliberately staggered: some should be visible within a year or two, others require the full cycle. Some of them will be wrong; that is the price of saying anything worth remembering. If most of them are right by the early 2030s, the thesis was not hype.</p>
  <ol class="predict">
    <li><span class="yr">By 2027</span><p>An agent-to-agent payment or settlement standard clears genuine sub-cent, machine-to-machine transactions in production, with meaningful volume from real services rather than speculation.</p></li>
    <li><span class="yr">By 2028</span><p>A prediction-market price is cited on the record in an official government, central-bank, regulator, or Fortune 500 procurement or risk decision.</p></li>
    <li><span class="yr">By 2028</span><p>Parametric cover is written and traded at building-and-season granularity — a specific structure, a specific fire or flood window — priced by model and settled by oracle, not by an adjuster's visit.</p></li>
    <li><span class="yr">By 2029</span><p>A regulated venue offers a real secondary market in standardized fractional revenue claims on private companies, underwritten directly from live accounting and bank-feed data rather than from a quarterly PDF.</p></li>
    <li><span class="yr">By 2030</span><p>Compute and energy trade on standardized, exchange-listed forward and option contracts — inference capacity, latency, and megawatts quoted with enough liquidity for non-specialists to hedge them.</p></li>
    <li><span class="yr">By 2030</span><p>A regulated secondary market quotes at least $10 billion of annual trading volume in small-business revenue-share claims against baskets of comparable firms, not just bilateral revenue-based financing.</p></li>
    <li><span class="yr">By 2031</span><p>The first synthetically unbundled single-segment equity exposure trades — cloud separated from retail, a “segment swap” — even though the underlying conglomerate never formally splits.</p></li>
    <li><span class="yr">Before 2032</span><p>At least one systemic scare is traced to correlated forced liquidation across markets that looked independent — the first cascade through the new wiring. I would rather be wrong about this one.</p></li>
  </ol>
</section>

<section>
  <span class="num">XII · Where the Value Goes</span>
...
<section class="series">
  <div class="rule-top">
    ...
    <p class="intro">This essay is the overview. The argument is developed rigorously across five working papers; the current drafts are linked below.</p>
    <ol class="papers">
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper1_costly_basis_incomplete_markets.pdf">The Costly Basis of Incomplete Markets.</a> <span class="pd">The value of a new market lives in the residual payoff directions existing markets fail to span; the form it takes is the cheapest admissible representation of those directions. Market creation as costly basis selection.</span></li>
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper2_synthetic_liquidity_long_tail_claims.pdf">Synthetic Liquidity for Long-Tail Claims.</a> <span class="pd">How a dealer quotes sparse claims by hedging common factors and warehousing the residual — when capacity scales, where it breaks, and why this is normal-time liquidity, not infinite liquidity.</span></li>
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper3_admissible_market_design.pdf">Admissible Market Design.</a> <span class="pd">When creation is cheap, the question becomes not whether a claim can trade but whether it should — hedging demand versus belief-driven speculation, claim-centric regulation, the human-capital boundary, manipulation, and systemic externality.</span></li>
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper4_state_contingent_claim_infrastructure.pdf">State-Contingent Claim Infrastructure.</a> <span class="pd">Prediction, insurance, and derivatives as one payoff layer with many wrappers, and the shared oracle-collateral-settlement stack that determines what payoff is actually delivered.</span></li>
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper5_computational_coase_theorem.pdf">The Computational Coase Theorem.</a> <span class="pd">Agents, transaction costs, and the minimum efficient transaction — why the smallest tradable exposure shrinks as software lowers the cost of using the price system, and why fiduciary agents matter when pricing can corrupt what it touches.</span></li>
    </ol>
