...
<section>
  ...
  <p>The formal spine is a theory of market birth. Existing markets already span many payoff directions and leave others uncovered. A new claim matters when it adds a residual direction people actually want to trade. Its cost, however, is not set by that payoff direction alone. It is set by the representation that delivers it: the index, oracle, legal wrapper, collateral rule, venue, and settlement procedure. Value lives on residual payoff directions; cost lives on contractual representations. The future fills in not all imaginable claims, but the claims whose residual value finally exceeds their cost of representation.</p>
  ...
  <p class="technical"><em>Technical version: <a target="_blank" rel="noopener" href="/writing/trillion-markets/paper1_costly_basis_incomplete_markets.pdf">The Costly Basis of Incomplete Markets</a> formalizes this as a residual-span value model with representation-dependent market-entry costs.</em></p>
...
<section>
  ...
  <p>A homeowner insures the house but not the income that pays the mortgage. A restaurant that lives and dies by the price of beef and the weather on a Friday hedges neither. A creator whose entire livelihood rides on one platform's ranking algorithm holds that risk completely undiversified. A small business with one big customer, a worker with one employer, a town with one industry — each sits on a large, perfectly nameable exposure and transfers almost none of it.</p>
...
<section>
  ...
  <p>“Trillions” sounds like rhetoric. It is an order-of-magnitude estimate, and the exact exponent is not the point. Reckon the dimensions along which a claim can be defined. The economically relevant entities in one large economy — firms, households, creators, vehicles, buildings, municipalities, machines — already run to the hundreds of millions. Each carries dozens of measurable exposures.</p>
  <p>Add horizons from minutes to years, locations or contexts, and contract wrappers — equity, debt, revenue share, option, future, swap, insurance, event contract, access right, basket. Even with conservative counts, the raw surface lands between tens and hundreds of trillions of candidate claims before a single basket, spread, or index multiplies the space again.</p>
  <p>But the raw combinatorics are not the argument. Most possible claims should never trade. Many are redundant with existing instruments. Many are too small to matter. Many cannot be verified. Many are illegal, manipulable, predatory, or socially destructive. The relevant object is the filtered space: claims that add a residual exposure existing markets do not already provide, whose payoff can be verified, whose risk can be priced or hedged, whose legal wrapper can be enforced, and whose social consequences are admissible.</p>
  <p>The claim is that this filtered space is still enormous. If the underlying space of measurable economic exposure is combinatorial, then even a tiny viable and admissible slice can be vast. The future does not price every possible state of the world. It prices the subset whose residual value exceeds the cost of representation.</p>
...
<section>
  ...
  <p>A market is <strong>bad</strong>, or at best a wash, when its dominant flow is disagreement-driven speculation with no underlying exposure, no offsetting consumption value, and no decision-improving price: a zero-sum transfer dressed as discovery. Much recreational sports betting is the bad kind. So is the roulette wheel. The mathematics of liquidity does not care about the distinction — a casino can be exquisitely liquid — but the welfare of the people inside it depends on nothing else.</p>
...
<section>
  ...
  <p>The third harm is human rather than systemic. An economy in which every action carries a price demands relentless calculation, and there is real value in the things that are <em>not</em> for sale — in courtesies with no meter running, in relationships not continuously marked to market.</p>
  <p>The cautionary artifact here is not a model but a man: years before any of this infrastructure existed, an individual issued a hundred thousand shares in himself and sold his shareholders votes over his own life — what to wear, which party to register with, whom to date. The lesson was not that the market failed but that it worked. His investors approved some life choices, constrained others, and eventually a relationship itself had to be unwound through the shareholder apparatus, with the partner's stake bought out like a position. That a thing <em>can</em> be priced is not an argument that it should be.</p>
...
<section>
  <span class="num">XII · What This Predicts</span>
...
<section class="series">
  <div class="rule-top">
    ...
    <ol class="papers">
      <li><a class="pt" target="_blank" rel="noopener" href="/writing/trillion-markets/paper1_costly_basis_incomplete_markets.pdf">The Costly Basis of Incomplete Markets.</a> <span class="pd">A theory of market birth: a new market is valuable only through residual payoff directions existing markets fail to span, while the form it takes is determined by the cheapest implementable representation of those directions. This explains why coarse indexes, baskets, and standardized claims often appear before bespoke claims.</span></li>
