...
<section>
  ...
  <p>We will not reach the theorist's dream of a price for every possible state of the world; most of that space is unmeasurable, illegal, redundant, or uneconomic. But we will approach a vast admissible slice of it far faster than anyone schooled on the old cost structure expects. The count of live, repricing markets at the end of that process is not in the thousands or the millions. It is plausibly in the trillions.</p>
...
<section>
  ...
  <p>The first harm is predation. Where humans negotiated too slowly to prey on each other at scale, agents do not. In decentralized markets, automated strategies already detect a pending transaction and reorder the queue to skim the value out of it. This is the class of extraction crypto people aptly call the dark forest, and it already runs into the billions a year. In a world where agents negotiate lane changes and crop futures alike, that predation generalizes, and it lands back on the core inequality: a tiny trade with real surplus is destroyed if the expected skim exceeds it.</p>
  <p>The defense is design: clear orders in discrete batches at a uniform price make the value of being microseconds faster evaporate. But the arms race between extraction and defense is a permanent feature, not a transient bug.</p>
